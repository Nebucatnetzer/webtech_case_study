...
#+ATTR_LATEX: :align |>{\columncolor[HTML]{EFEFEF}}p{.25\textwidth}|p{.7\textwidth}| :placement [H]
...
| *Alternative Flow*  | 1. Der Administrator loggt sich unter https://didgeridoo.ml/admin ein. |
|                     | 2. Admin klickt neben "Articles" auf "+ Add". |
|                     | 3. Admin füllt das Formular aus, vergisst jedoch ein Feld und lädt ein Bild hoch. |
|                     | 4. Klickt unten rechts auf "Save". |
|                     | 5. Die Website gibt eine entsprechende Fehlermeldung aus. |
|                     | 6. Der Admin füllt die Felder aus und klickt auf "Save". |
